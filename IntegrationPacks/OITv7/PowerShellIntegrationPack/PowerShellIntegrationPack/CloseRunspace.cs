namespace PowerShellIntegrationPack
{
    ...
    [Activity("Close Runspace", Description = "Close the PowerShell runspace by the name")]
    public class CloseRunspace : IActivity
    {
            ...
            IActivityResponse response)
        {
            ...
            var ret = PowerShellClient.CloseRunspace(
