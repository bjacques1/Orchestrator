namespace PowerShellIntegrationPack
{
    ...
    class EventTracing
    {
        const string EtwProviderId = "{34D75F6B-7F81-4998-845B-B0DECA82F235}";
        const string EtwListenerName = "PowerShellIP Listener";
        const string EtwProviderName = "PowerShellIPProvider";
        ...
        static EventTracing()
        {
            providerId = new Guid(EtwProviderId);
